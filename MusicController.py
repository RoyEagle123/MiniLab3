...
class MusicController:
    ...
    def __init__(self):
        ...
        # do the handling
        self._button1 = Button(3, "white", buttonhandler=None)
        self._button2 = Button(6, "red", buttonhandler=None)
        self._button3 = Button(4, "yellow", buttonhandler=None)
        self._button4 = Button(5, "blue", buttonhandler=None)
